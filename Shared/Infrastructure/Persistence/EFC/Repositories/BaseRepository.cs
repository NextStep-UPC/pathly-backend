using pathly_backend.Shared.Domain.Repositories;
using pathly_backend.Shared.Infrastructure.Persistence.EFC.Configuration;
using Microsoft.EntityFrameworkCore;

namespace pathly_backend.Shared.Infrastructure.Persistence.EFC.Repositories;
